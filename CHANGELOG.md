...
- 92403c4: Extend Highlight support beyond ground-clamped geometry
...
- 07c8f8b: Deprecate fallbackProvider and TerrainRegion.contains
...
- aff6bc8: Fix credit property getter
...
- b1624d0: Align `HybridTerrainProvider` with the `TerrainProvider` interface
...
- 00c5772: Fix dual-package exports and declaration file generation
...
- e07a5be: Reorganize module structure and relocate development utilities
...
- 9750e2f: Refactor internal utilities and enhance security
...
- 3769a2c: Enhance Sunlight experimental API with async analysis and improved accuracy
...
- 324771e: fix: Fix HybridTerrainProvider region delegation and terrain availability caching
...
- 23a1122: feat: Replace entity-based visualization with HybridImageryProvider at TerrainVisualizer
...
- 84ae09c: test: Upgrade Vitest to 4.x and fix test compatibility
